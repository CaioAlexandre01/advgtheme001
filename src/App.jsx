      ...
      <div className="relative z-20">
        ...
        <section id="contato" className="py-auto bg-[#2C333C] text-center">
          <div className="container mx-auto px-4">
            ...
            <a href="https://wa.me/1234567890" className="bg-green-600 text-white py-3 px- rounded-lg text-lg flex items-center justify-center gap-3 hover:bg-green-700 transition duration-300">
              <FaWhatsapp className="text-2xl" /> Fale Comigo no WhatsApp
            </a>
          </div>
        </section>
